...
export default function Services() {
    return (
      ...
      <section id="services" className="flex flex-col lg:snap-start gap-5 lg:h-screen h-auto items-center justify-center w-screen overflow-hidden p-4 md:p-10">

        <h2 className="lg:text-6xl text-3xl mt-10 md:mt-0 font-bold text-center animated-gradient-text">My Services</h2>

        <div className="flex flex-row flex-nowrap w-full h-auto md:p-5 p-0 items-center justify-start lg:gap-5 lg:mt-10 gap-5 overflow-x-auto scrollbar-hide">
